  ...
  return (
    <div className="privacy-policy-container">
      ...
      <section>
        <h2>Introduction</h2>
        <p>
          At Foodie, we deeply value the trust you place in us and are committed
          to ensuring secure transactions and protecting your information
          privacy. This Privacy Policy outlines how Foodie Technologies Private
          Limited and its affiliates (collectively "Foodie, we, our, us")
          collect, use, share, protect, or otherwise process your personal data
          through our website{" "}
          <a href="https://www.foodie.in" target="_black">https://www.foodie.in</a> and our
          mobile application (collectively, the "Platform"). You may browse
          certain sections of the Platform without registering, but please note
          that our services are currently offered only within India, and your
          personal data will primarily be stored and processed in India. By
          using our Platform, providing your information, or availing any
          service offered, you expressly agree to be bound by this Privacy
      ...
      <section>
        ...
        <p>
          ...
          preferences, making your interactions with Foodie easier and more
        ...
        <p>
          ...
          programs offered through Foodie, we collect data such as your name,
      ...
      <section>
        <h2>Sharing</h2>
        <p>
          We may share your personal data within Foodie’s corporate group,
      ...
      <section>
        ...
        <p>
          ...
          partners or payment gateways, which collect personal data. Foodie is
      ...
      <section>
        ...
        <p>
          ...
          authority to do so. You permit Foodie, its affiliates, and partners to
      ...
      <section>
        ...
        <p>
          ...
          <br />
          <strong>Foodie Technologies Pvt Ltd</strong>,<br />
